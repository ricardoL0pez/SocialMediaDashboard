...
export const OverviewCard = ({ network, user, audience, audienceType, today, isUp }) => {
    return (
        <article className=" bg-Light-Grayish-Blue dark:bg-Dark-Desaturated-Blue w-[326px] h-[216px] mb-4 rounded-[5px] mx-auto overflow-hidden text-center hover:brightness-95 cursor-pointer hoer:dark:brightness-135">
